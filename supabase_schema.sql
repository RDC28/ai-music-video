...
-- 9. Global Locations Library (Shared across projects)
...
-- 10. Enable RLS and Policies for Locations Library
ALTER TABLE locations_library ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Users can read own locations" ON locations_library;
